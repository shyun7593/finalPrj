...
<!-- 로그인 시작 { -->
<div>
    <div id="mb_login" class="mbskin" style="width:80vw;border-radius:10px;height:fit-content;border:5px solid black;">
    <img style="width: 35vw;margin-bottom:30px;" src="/img/final_logo.png">
    ...
    <div class="mbskin_box" style="font-size: 1.5em;">
        ...
        <fieldset id="login_fs">
            <legend>회원로그인</legend>
            <div style="color:black; text-align:left;">아이디</div>
            <label for="login_id" class="sound_only">회원아이디<strong class="sound_only"> 필수</strong></label>
            <input type="text" name="mb_id" id="login_id" required class="frm_input required" size="20" maxLength="20" placeholder="아이디">
            
            <div style="color:black; text-align:left;">비밀번호</div>
            ...
            <button type="button" style="background-color: #000 !important;padding:0.1em 0;height:auto;" onclick="doAct('login')" class="btn_submit btn-view active" id="login-btn">로그인</button>
            <button type="button" style="background-color: #000 !important;padding:0.1em 0;height:auto;" onclick="doAct('reg')" class="btn_submit btn-view" id="reg-btn">회원가입</button>
