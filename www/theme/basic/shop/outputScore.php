    ...
    <div id="smb_my_list" style="width: 100%;">
        <section id="smb_my_od" style="margin:unset;">
                ...
                <input type="hidden" id="his_Code" name="his_Code" value="C20060001">
                        ...
                        <div class="tbl_wrap">
                            <table class="tbl_head01 tbl_2n_color" style="margin:0px !important;padding:5px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th><button class="btn-n active" onclick="resetScore()">초기화</button></th>
                                        <th>국어</th>
                                        <th>수학</th>
                                        <th>영어</th>
                                        <th>탐구1</th>
                    ...
                    <button type="button" id="viewhideOutput" style="width:30px;height:30px;bottom:-10px;left:-30px;position: absolute;border: unset;border-radius: 50%;color: white;background: #0c2233;transform: rotate(0deg);"><i id="hide_btn" class="xi-caret-up"></i></button>
                </div>
            </form>
        </section>
    <div id="smb_my_list">
        <div>
            <h2 style="padding:15px 0 !important;font-size: 1.2em;background:white;">전체 : <span class="totalCnt"></span>
