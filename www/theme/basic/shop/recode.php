                ...
                <table class="tbl_head01" style="width: auto;">
                    <thead >
                        <tr class="headd">
                            ...
                            <th style="top:0;z-index:15;min-width:100px;width:100px;background:rgba(227, 244, 248);" rowspan="2">이름</th>
                            <th style="top:0;z-index:15;min-width:50px;width:50px;background:rgba(227, 244, 248);" rowspan="2">성</th>
                            <th style="top:0;z-index:15;min-width:180px;width:180px;background:rgba(227, 244, 248);" rowspan="2">학교</th>
                            <th style="top:0;z-index:15;min-width:50px;width:50px;background:rgba(227, 244, 248);" rowspan="2">학년</th>
                            <th style="top:0;z-index:15;min-width:100px;width:100px;background:rgba(227, 244, 248);" rowspan="2">캠퍼스</th>
                            <th style="position:sticky;top:0;z-index:13;min-width:100px;width:100px;background:rgba(227, 244, 248);" class='core' colspan="2">배근력</th>
                            <th style="position:sticky;top:0;z-index:13;min-width:100px;width:100px;background:rgba(227, 244, 248);" class='m10m' colspan="2">10m왕복</th>
                            <th style="position:sticky;top:0;z-index:13;min-width:100px;width:100px;background:rgba(227, 244, 248);" class='medicine' colspan="2">메디신</th>
                            <th style="position:sticky;top:0;z-index:13;min-width:100px;width:100px;background:rgba(227, 244, 248);" class='leftGul' colspan="2">좌전굴</th>
                            <th style="position:sticky;top:0;z-index:13;min-width:100px;width:100px;background:rgba(227, 244, 248);" class='stand' colspan="2">제멀</th>
                            <th style="position:sticky;top:0;z-index:13;min-width:100px;width:100px;background:rgba(227, 244, 248);" class='m20mBu' colspan="2">20m부저</th>
                            <th style="position:sticky;top:0;z-index:13;min-width:100px;width:100px;background:rgba(227, 244, 248);" class='situp' colspan="2">윗몸</th>
                            <th style="position:sticky;top:0;z-index:13;min-width:100px;width:100px;background:rgba(227, 244, 248);" class='sergent' colspan="2">서전트</th>
