...
// }
  ...
  window.addEventListener('DOMContentLoaded', () => {
    const menuStatus = localStorage.getItem('menuStatus') || 'open';
  ...
  function menuOnOff() {
    ...
    const isClosing = !menu.classList.contains('hidden');
  
    menu.classList.toggle('hidden');
    wrapper.classList.toggle('full');
    hideBtn.classList.toggle('hidden');
  
    localStorage.setItem('menuStatus', isClosing ? 'closed' : 'open');
  }
